...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-white text-zinc-950 selection:bg-amber-100 flex flex-col font-sans">
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 py-20 animate-in fade-in zoom-in-95 duration-1000 w-full">
        {!data ? (
          <div className="max-w-[1600px] mx-auto w-full flex flex-col items-center">
            ...
            <div className="w-full max-w-2xl bg-white border-4 border-zinc-950 rounded-sm shadow-[12px_12px_0px_0px_rgba(9,9,11,1)] overflow-hidden transition-all hover:shadow-[16px_16px_0px_0px_rgba(9,9,11,1)]">
              {/* Industrial Toolbar */}
              ...
              <div className="p-12 space-y-10">
                ...
                {!user ? (
                   <div className="flex flex-col sm:flex-row items-center justify-between gap-6 p-8 border-4 border-dashed border-zinc-100 rounded-sm bg-zinc-50/50 group hover:border-amber-400 transition-colors">
                      <div>
                ...
                <div className="relative">
                   ...
                   <div className="relative flex justify-center text-[11px] font-medium uppercase tracking-[0.4em] text-zinc-500"><span className="bg-white px-6 italic">Or Public Analysis</span></div>
                </div>

                <div className="space-y-4">
                  <div className="flex items-center justify-between px-2">
                    <label className="text-[11px] font-medium uppercase tracking-[0.2em] text-zinc-950 italic">Source Repository URL</label>
                    <span className="text-[10px] font-semibold text-zinc-600 uppercase tracking-widest">Public Domain</span>
                  </div>
