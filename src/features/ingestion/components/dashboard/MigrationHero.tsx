      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white p-6 border-4 border-dashed border-zinc-200 rounded-sm shadow-[6px_6px_0px_0px_rgba(0,0,0,0.05)]">
           <div className="flex items-center gap-3 mb-6">
              ...
              <span className="text-[10px] font-black uppercase tracking-widest text-zinc-500">Source Environment (Legacy)</span>
           </div>
        ...
        <div className="bg-zinc-950 p-6 border-4 border-zinc-950 rounded-sm shadow-[6px_6px_0px_0px_rgba(251,191,36,0.15)] flex flex-col justify-between overflow-hidden relative group">
           ...
           <div className="flex items-center gap-3 mb-4 relative z-10">
              ...
              <span className="text-[10px] font-black uppercase tracking-widest text-zinc-400">Target Destination</span>
           </div>
           <div className="relative z-10">
              <h4 className="text-xl font-black text-white uppercase italic leading-none">{targetStack.framework}</h4>
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-white p-6 border-4 border-zinc-950 rounded-sm shadow-[8px_8px_0px_0px_rgba(9,9,11,1)]">
           <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-[10px] font-black uppercase tracking-widest text-zinc-500">Modernization Feasibility</span>
           </div>
           <div className="flex items-end gap-3">
              <span className="text-5xl font-black text-zinc-950 italic leading-none">{score}%</span>
        ...
        <div className="bg-amber-400 p-7 border-4 border-zinc-950 rounded-sm shadow-[8px_8px_0px_0px_rgba(9,9,11,1)] flex flex-col justify-center italic relative overflow-hidden">
           ...
           <p className="text-[11px] font-black leading-relaxed text-zinc-950 uppercase opacity-90 relative z-10">
            ...
            {coreFeatures.map((feature, i) => {
              ...
              return (
                <div key={i} className="bg-zinc-50 border-2 border-zinc-200 p-5 rounded-sm hover:border-zinc-950 transition-all group shadow-[4px_4px_0px_0px_rgba(0,0,0,0.05)] hover:shadow-[4px_4px_0px_0px_rgba(9,9,11,1)]">
                  <h5 className="text-[10px] font-black uppercase text-zinc-950 mb-2 leading-none border-l-4 border-amber-400 pl-3">
                    {f.label}
                  </h5>
          ...
          {roadmap.length > 0 ? roadmap.map((phase, i) => (
            <div key={i} className="group flex items-stretch gap-6 animate-in fade-in slide-in-from-left-4 duration-500" style={{ animationDelay: `${i * 150}ms` }}>
              <div className="flex flex-col items-center">
                  <div className="w-10 h-10 rounded-sm bg-zinc-950 text-white flex items-center justify-center border-4 border-zinc-950 group-hover:bg-amber-400 group-hover:text-zinc-950 transition-colors z-10 font-black italic text-sm">
              ...
              <div className="flex-1 pb-8">
                 <div className="bg-white border-4 border-zinc-950 p-8 rounded-sm shadow-[8px_8px_0px_0px_rgba(9,9,11,1)] group-hover:shadow-[8px_8px_0px_0px_rgba(251,191,36,1)] transition-all relative overflow-hidden">
                    <div className={`absolute top-0 right-0 px-4 py-1 text-[8px] font-black uppercase tracking-widest border-l-4 border-b-4 border-zinc-950 ${
                    ...
                    <h4 className="text-sm font-black uppercase tracking-widest text-zinc-950 mb-6 italic underline decoration-amber-400 decoration-8 underline-offset-8 leading-none pb-1">
                      {phase.phase}
                    </h4>
            ...
            <div className="p-12 border-4 border-dashed border-zinc-200 rounded-sm text-center">
              ...
              <p className="text-[10px] font-black uppercase tracking-widest text-zinc-400 italic">Initiate a surgical scan to generate modernization roadmap.</p>
            </div>
          )}
        </div>
      </section>
      ...
      {businessRules.length > 0 && (
        <section className="bg-zinc-950 p-8 border-4 border-zinc-950 shadow-[10px_10px_0px_0px_rgba(251,191,36,1)] rounded-sm">
           <div className="flex items-center gap-3 mb-8">
              <Layers size={18} className="text-amber-400" />
              <span className="text-[10px] font-black uppercase tracking-widest text-white italic underline decoration-amber-400">Business Logic Registry</span>
           </div>
