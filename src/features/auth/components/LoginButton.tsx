...
export const LoginButton: React.FC = () => {
  ...
  if (user) {
    return (
      <div className="flex items-center gap-4 animate-fade-in">
        ...
        <div className="w-8 h-8 rounded-sm bg-secondary border border-border overflow-hidden">
  ...
  return (
    <Button
      onClick={onLogin}
      variant="outline"
      className="flex items-center gap-2 px-3 py-2 text-xs font-semibold h-9"
    >
